...
class BBoxTestMixin(object):
    ...
    if sys.version_info >= (3, 7):
        ...
        async def async_test_bboxes(self,
            ...
            # print(f'[class BBoxTestMixin] cls_score={cls_score}')
            # print(f'[class BBoxTestMixin] bbox_pred={bbox_pred}')
    ...
    def simple_test_bboxes(self,
        ...
        rois = rois.view(-1, 5)
        # print(f'\n[test_mixins] def simple_test_bboxes call _bbox_forward')
        bbox_results = self._bbox_forward(x, rois)
        cls_score = bbox_results['cls_score']
        bbox_pred = bbox_results['bbox_pred']
        # print(f'\n[test_mixins] def simple_test_bboxes _bbox_forward return cls_score and bbox_pred')
        ...
        if bbox_pred is not None:
            ...
            if isinstance(bbox_pred, torch.Tensor):
                ...
                det_bboxes = []
                det_labels = []
                # print(f'\n[test_mixins] def simple_test_bboxes call bbox_head.get_bboxes')
