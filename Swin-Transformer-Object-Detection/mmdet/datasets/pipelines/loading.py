...
class LoadAnnotations(object):
    ...
    def _load_bboxes(self, results):
        ...
        # FOR SHIFT Dataset
        results['truelabels'] = ann_info['truelabels'].copy()
    ...
    def _load_labels(self, results):
        ...
        # FOR SHIFT Dataset
        results['truelabels'] = results['ann_info']['truelabels'].copy()
        return results
...
class FilterAnnotations(object):
    ...
    def __call__(self, results):
        ...
        if not keep.any():
            ...
            # truelabels
            keys = ('truelabels', 'gt_bboxes', 'gt_labels', 'gt_masks', 'gt_semantic_seg')
            for key in keys:
                if key in results:
