    ...
    def _resize_bboxes(self, results):
        ...
        for key in results.get('bbox_fields', []):
            if results[key].ndim == 1:
                print(f'Pass this, bbox shape={results[key].shape}, scale_factor={results["scale_factor"]}')
                continue
            # print(f'bbox shape={results[key].shape}, scale_factor={results["scale_factor"]}')
                ...
                for key in results.get('bbox_fields', []):
                    ...
                    if key in ['gt_bboxes']:
                        if 'gt_labels' in results:
                            ...
                            # FOR SHIFT Dataset
                            results['truelab/els'] = results['truelabels'][mask]
