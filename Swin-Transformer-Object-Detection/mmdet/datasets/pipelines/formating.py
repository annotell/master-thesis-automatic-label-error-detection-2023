...
class ToDataContainer(object):
    ...
    # , dict(key='truelabels')
    def __init__(self,
                 fields=(dict(key='img', stack=True), dict(key='gt_bboxes'), dict(key='gt_labels'), dict(key='truelabels'))):
        self.fields = fields
...
class DefaultFormatBundle(object):
    ...
    def __call__(self, results):
        ...
        # truelabels
        for key in ['proposals', 'gt_bboxes', 'gt_bboxes_ignore', 'gt_labels', 'truelabels']:
