...
coco_shiftall_name2red = {k: (255, 0, 0) for k in coco_shiftall_det.values()}
coco_shiftall_name2white = {k: (255, 255, 255) for k in coco_shiftall_det.values()}
coco_shiftall_name2RGB = {
    "car": (197, 202, 233),
    "truck": (155, 249, 196),
    "bus":(178, 235, 242),
    "person":(245, 245, 245),
